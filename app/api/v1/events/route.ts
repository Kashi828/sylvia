...
export async function GET(request: Request) {
  ...
  const durable = await listDeviceEvents(auth.ownerId,{projectId:auth.projectId,deviceId:url.searchParams.get("deviceId")||undefined,kind:url.searchParams.get("kind")||undefined,limit});
