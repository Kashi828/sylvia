/* SYLVIA Arduino SDK — ESP8266 Cloud Test — v0.53.8 */
...
void setup() {
  ...
  Serial.print("SYLVIA SDK "); Serial.print(Sylvia::sdkVersion()); Serial.println(" initialized; protocol handshake and reconnect recovery will run automatically");
}
