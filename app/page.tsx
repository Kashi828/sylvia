...
function SchedulesPanel({schedules,onToggle,onRun,onAdd,devices}:{schedules:Schedule[];onToggle:(id:number)=>void;onRun:(s:Schedule)=>void;onAdd:()=>void;devices:Device[]}){
 ...
 <div className="panel"><div className="apiTitle"><Bell size={17}/><div><b>Scheduler execution model</b><span>Every minute the worker checks enabled schedules, respects each configured timezone and day set, creates a persistent command, and records the result.</span></div></div></div></div>
}
