...
function showLaunchScreen() {
  ...
  page.innerHTML = `
    ...
    <section class="sl-hero">
      ...
      <div class="sl-console"><div class="sl-window"><div class="sl-windowbar"><i></i><i></i><i></i><span>SYLVIA CONSOLE</span></div><div class="sl-dash"><div class="sl-dash-card"><small>DEVICES</small><b>Connected</b><span class="sl-chip">READY</span></div><div class="sl-dash-card"><small>TELEMETRY</small><b>Live</b><span class="sl-chip">REALTIME</span></div><div class="sl-dash-card sl-chart"><small>TEMPERATURE · LIVE</small><svg viewBox="0 0 500 145" preserveAspectRatio="none"><path d="M0 110 C35 100 45 72 80 86 S130 112 165 72 S220 52 255 75 S305 112 340 62 S390 48 425 69 S465 54 500 28" fill="none" stroke="#9ea9ff" stroke-width="3"/><path d="M0 145 L0 110 C35 100 45 72 80 86 S130 112 165 72 S220 52 255 75 S305 112 340 62 S390 48 425 69 S465 54 500 28 L500 145Z" fill="rgba(126,151,255,.08)"/></svg></div></div></div></div>
    </section>
